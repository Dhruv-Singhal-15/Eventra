...
if(isset($_GET['login']))
{
    ...
    $sql1="select * from login where userid='".$uid."' and password='".$pass."'";
...
if(isset($_GET['register']))
{
    ...
    $sql2="insert into login values('".$uid."','".$pass."',0)";
...
<body>
  <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="eventra.php">Eventra</a>
  ...
  <div class="container">
    <p style="font-weight: bold;">Enter Login Details</p>
    <div>
      <form class="form" action="login.php" method="get">
        ...
        <p style="color:white;">Not registered?</p>
