...
$sql2="select * from decorations order by decor_price";
$result2= mysqli_query($con,$sql2);
$sql3="select * from decorations order by decor_price desc";
$result3= mysqli_query($con,$sql3);
$sql4="select * from decorations order by decor_ratings desc";
...
$sqlbooking="select decor_price from decorations where decor_id='".$desiredid."'";
